...
Public Class FrmDisplayImages
    ...
    Sub DisplayData()
        ...
        Dim str As String = "SELECT ScanImg  FROM TbViewScannerFilesClince WHERE (IDSc)='" & TxtNCode.ToString & "'"
    ...
    Private Sub BtnNew_Click(sender As System.Object, e As System.EventArgs) Handles BtnNew.Click
        ...
        End With
        Sql = "select     IDSc, NoCode, Emp_no, FullName, Notes, ScanImg, DateReg from TbViewScannerFilesClince"
    ...
    Private Sub BtnFind_Click(sender As System.Object, e As System.EventArgs) Handles BtnFind.Click
        ...
        If TxtFind.Text <> Nothing Then
            ...
            Sql += " Or (Emp_no) like N'%" & Trim(Me.TxtFind.Text) & "%' or (FullName) like '%" & Trim(Me.TxtFind.Text) & "%'"
        End If
    ...
    Private Sub BtnDel_Click(sender As System.Object, e As System.EventArgs) Handles BtnDel.Click
        ...
        Dim sql As String = "DELETE FROM TbScannerFilesClince   WHERE ([IDSc] ='" + DGVDataPics.CurrentRow.Cells("IDSc").Value.ToString + "')"
