...
Public Class FrmScannFile
    ...
    Private Sub BtnSave_Click(sender As System.Object, e As System.EventArgs) Handles BtnSave.Click
        ...
        '    Exit Sub
        'End If
        If TxtNoEmp.Text = Nothing Then
            MessageBox.Show("اسف .. من فضلك قم بكتابة رقم الموظف في مربع الادخال ...", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Warning)
            TxtNoEmp.Focus()
            Exit Sub
        End If

        If TxtEmpName.Text = Nothing Then
            MessageBox.Show("اسف .. من فضلك لم يتم اختيار اسم الموظف من مربع الادخال ...", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Warning)
            TxtNoEmp.Focus()
            Exit Sub
        End If
        ...
        'Dim n As Int16 = MyClss.ExecuteScalar("SELECT Count(*) From TbScannerFilesClince Where NoCode='" + TxtNoFile.Text.Trim + "'")
        ''TbInvoiceDetalis
        'If n > 0 Then
        ...
        TestRunCode = False
        Sql = "INSERT INTO TbScannerFilesClince ( NoCode, Notes, ScanImg,Emp_no)"
        Sql += " VALUES (@NoCode, @Notes, @ScanImg,@Emp_no) "
        ...
        Try
            With CMD1
                ...
                .Parameters.Add("@Emp_no", SqlDbType.Int).Value = TxtNoEmp.Text
    ...
    Private Sub BtnNew_Click(sender As System.Object, e As System.EventArgs) Handles BtnNew.Click
        ...
        TxtNoEmp.Clear()
        TxtNoEmp.Focus()
        Sql = "Select Emp_no from TbViewDataEmp "
        AutocompleteSql(Sql, TxtNoEmp)
    End Sub
    ...
    Private Sub TxtNoEmp_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtNoEmp.KeyDown
        If e.KeyCode = Keys.Enter Then
            If TxtNoEmp.Text = Nothing Then Exit Sub

            Dim Tb As New DataTable
            Sql = "Select FullName from TbViewDataEmp  Where Emp_no='" + TxtNoEmp.Text.Trim + "'"
            Tb = MyClss.GetRecords(Sql)
            If Tb.Rows.Count > 0 Then
                TxtEmpName.Text = Tb.Rows(0).Item(0).ToString
                TxtNotes.Focus()
            Else
                TxtEmpName.Text = Nothing
            End If
    ...
    Private Sub TxtNoEmp_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtNoEmp.TextChanged
